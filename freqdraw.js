...
function back(){
    ...
    // ctx.beginPath();
    // ctx.strokeStyle = "black";
    // ctx.moveTo(mainCanvas.width/2-340, 0);
    // ctx.lineTo(mainCanvas.width/2-340, mainCanvas.height);
    // ctx.closePath();
    // ctx.stroke();
    ...
    // ctx.beginPath();
    // ctx.strokeStyle = "black";
    // ctx.moveTo(mainCanvas.width/2-309, 0);
    // ctx.lineTo(mainCanvas.width/2-309, mainCanvas.height);
    // ctx.closePath();
    // ctx.stroke();
